...
const SajuReport44 = () => {
    ...
    const { nextFortune, nextYear, name } = location.state || {};
    ...
    return (
        <div className="saju-report2-wrapper">
            <h1 className="report-title">
                33. {nextYear}년 {name}님의 운세, 조언을 알려드립니다
            </h1>
            <p className="report-subtitle">
                안정감과 성실함을 바탕으로 성장과 신뢰를 쌓아갈 수 있는 시기입니다
            </p>

            <div className="report-content">
                {/* 왼쪽: 주요 변화 */}
                <div className="analysis-container">
                    <h2 className="analysis-title">{`${nextFortune} 운에 개선하거나 주의해야 할 점들`}</h2>
                    <ul className="strengths-list">
                        {nextAnalysis.TitleDescription?.map((item, index) => (
                            <li key={index}>
                ...
                <div className="analysis-image-container">
                    <p>{nextAnalysis.centerDescription(name)}</p>
                    <img
                    ...
                    <p className="gender-description">
                        {gender === 'male'
                            ? nextAnalysis.MaleDescription
                            : nextAnalysis.FeMaleDescription}
                    </p>
                </div>
            </div>
